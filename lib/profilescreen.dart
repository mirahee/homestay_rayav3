...
class _ProfileScreenState extends State<ProfileScreen> {
                            ...
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      "http://192.168.176.247/assets/profileimages/${widget.user.id}.png?v=$val",
                                      //"assets/profileimages/profile.png",
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (content) => const LoginScreenView()));
              },
            ),
            TextButton(
              child: const Text(
  ...
  void _updateProfileImage(image) {
    ...
    http.post(Uri.parse("http://192.168.176.247/php/update_profile.php"),
        body: {
  ...
  void _updatePhone(String newphone) {
    http.post(Uri.parse("http://192.168.176.247php/update_profile.php"),
        body: {
          "userid": widget.user.id,
          "newphone": newphone,
        }).then((response) {
