                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "http://192.168.176.247//assets/productimages/${productList[index].productId}.png",
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "http://192.168.176.247/php/loadsellerproducts.php?userid=${widget.user.id}"),
    )
        .then((response) {
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("http://192.168.176.247/php/delete_product.php"), body: {
