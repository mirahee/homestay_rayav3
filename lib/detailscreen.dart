...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    ...
    _praddrEditingController.text = widget.product.productDelivery.toString();
            ...
            Card(
              ...
              child: Container(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl:
                        "http://192.168.176.247/assets/productimages/${widget.product.productId}.png",
  ...
  void _updateProduct() {
    ...
    http.post(Uri.parse("http://192.168.176.247/php/update_product.php"), body: {
